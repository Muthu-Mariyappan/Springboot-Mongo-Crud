...
public class JPAwithMongodbController {
	...
	public Map<String,String> find(@PathVariable BigInteger id){
		...
		if(this.studentService.find(id).isPresent()) { // if the given student id is present
			...
			message.put("Department", foundStudent.getDepartmentName());
		}
		else { 
	...
	public Map<String,String> insertStudent(@RequestParam("id") BigInteger id,@RequestParam("name") String name,@RequestParam("cgpa") double cgpa,@RequestParam("department") String deptName){
		...
		Student newStudent;
			...
			newStudent.setDepartmentName(deptName);
			...
			if(this.studentService.insert(newStudent)!=null) {
				...
				message.put("Department", deptName);
			}
			else
	...
	public Map<String,String> updateStudent(@RequestParam("id") BigInteger id,@RequestParam("name") String name,@RequestParam("cgpa") double cgpa,@RequestParam("department") String deptName){
		System.out.println("\nrunning update");
		Map<String,String> message = new LinkedHashMap<>();
		Student newStudent;
	...
	public Map<String,String> deleteStudent(@PathVariable("id") BigInteger id){
		Map<String,String> message = new LinkedHashMap<>();
		Student oldStudent;
		if(this.studentService.find(id).isPresent()) {	
			...
			message.put("Department", oldStudent.getDepartmentName());
